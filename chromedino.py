...
pygame.display.set_caption('Skipper vs TEXAS')

Ico = pygame.image.load('assets/Dino/Start.png').convert_alpha()
pygame.display.set_icon(Ico)

RUNNING = [pygame.image.load(os.path.join('assets/Dino', 'Run1.png'
           )).convert_alpha(), pygame.image.load(os.path.join('assets/Dino',
           'Run2.png')).convert_alpha()]
JUMPING = pygame.image.load(os.path.join('assets/Dino', 'Start.png')).convert_alpha()
DUCKING = [pygame.image.load(os.path.join('assets/Dino', 'Slide.png'
           )).convert_alpha(), pygame.image.load(os.path.join('assets/Dino',
           'Slide.png')).convert_alpha()]

SMALL_CACTUS = [pygame.image.load(os.path.join('assets/Cactus',
                'SmallCactus1.png')).convert_alpha(),
                pygame.image.load(os.path.join('assets/Cactus',
                'SmallCactus2.png')).convert_alpha(),
                pygame.image.load(os.path.join('assets/Cactus',
                'SmallCactus3.png')).convert_alpha()]
LARGE_CACTUS = [pygame.image.load(os.path.join('assets/Cactus',
                'LargeCactus1.png')).convert_alpha(),
                pygame.image.load(os.path.join('assets/Cactus',
                'LargeCactus2.png')).convert_alpha(),
                pygame.image.load(os.path.join('assets/Cactus',
                'LargeCactus3.png')).convert_alpha()]
...
def main():
    ...
    y_pos_bg = 380
    points = 0
    font = pygame.font.Font('comici.ttf', 20)
    obstacles = []
    death_count = 0
